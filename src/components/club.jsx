...
export default function BCICard() {
  const experiences = [
    {
      title: "Technical Chair",
      company: "Brain Computer Interface Club USF",
      badges: ["NodeJS", "TensorFlow", "Machine Learning"],
      period: "2025 - Present",
      location: "Tampa, FL",
      description: [
        "• Led technical workshops on NodeJS, and TensorFlow, empowering students to build full-stack applications and AI models.",
    ...
    },
    {
      ...
      location: "Tampa, FL",
      description: [
        "• Created engaging content translating complex BCI concepts for diverse audiences.",
        "• Developed strategic communication plan that increased club visibility by 40%.",
      ],
    },
  ];
